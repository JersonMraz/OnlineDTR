...
// Fix: define explicit prop type instead of inferring from Tooltip component props
...
// Fix: use LegendProps directly instead of Pick with "payload" which no longer exists on the constraint
